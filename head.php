        ...
        <div class="container">
            ...
            <div class="nav-links">
                <ul>
                    ...
                    <li><a href="../Interfaces/Logout.php">Logout</a></li>
                    
                    <?php }else{ ?>
                    <li><a href="../Interfaces/Public Home.php">Home</a></li>
                    <li><a href="../Interfaces/Login.php">Login</a></li>
                    <li><a href="../Interfaces/Registration.php">Registration</a></li>
                <?php } ?>
                </ul>
            </div>
        </div>
